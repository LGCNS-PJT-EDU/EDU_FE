        ...
        <section className="border rounded-lg">
          ...
          <AnimatePresence initial={false}>
            {openRec && (
              ...
              >
                <p>
                  TakeIT는 모든 사용자가 효율적으로 성장할 수 있도록 설계된 디지털 학습
                  플랫폼입니다.
                </p>
                <p>
                  사용자는 로드맵 설계, 실력 진단, 사전·사후 평가, AI 면접, 맞춤형 컨텐츠 추천 등
                  다양한 기능을 통해 본인만의 학습 경로를 만들어갈 수 있습니다.
                </p>
                <p>
                  각 기능은 사용자의 목표, 성취도, 학습 이력에 기반해 개인화된 경험을 제공하며, 이를
                  통해 자기주도적 학습과 실질적인 실력 향상을 지원합니다.{' '}
                </p>
                <p>
                  TakeIT는 사용자의 편의와 성장을 최우선으로 하며, 더 나은 서비스 제공을 위해
                  지속적으로 기능을 개선해 나가고 있습니다.
                </p>
              </motion.div>
            )}
          </AnimatePresence>
        ...
        <section className="border rounded-lg">
          ...
          <AnimatePresence initial={false}>
            {openPol && (
              ...
              >
                <p>
                  TakeIT 서비스 내 이용자 식별, 회원관리 및 서비스 제공을 위해 회원번호와 함께
                  개인정보를 수집합니다. 해당 정보는 동의 철회 또는 서비스 탈퇴 시 지체없이
                  파기됩니다. 아래 동의를 거부할 권리가 있으며, 동의를 거부할 경우 서비스 이용이
                  제한됩니다.
                </p>
                <p>
                  [수집 목적] <br /> TakeIT 서비스 내 이용자 식별, 회원관리 및 서비스 제공
                </p>
                <p>
                  [수집 항목] <br /> 이메일 주소, 비밀번호, 서비스 이용 내역
                </p>
                <p>
                  [보유 기간] <br /> 서비스 종료 또는 서비스 탈퇴 시 지체없이 파기
                </p>
              </motion.div>
            )}
          </AnimatePresence>
