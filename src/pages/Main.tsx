...
export default function Main() {
  ...
  return (
    <div className="relative w-full font-[NeoDunggeunmo]">
      ...
      <section
        ref={bottomRef}
        className="relative min-h-screen snap-start w-full flex flex-col items-center text-center max-w-[900px] px-4 mx-auto pt-20 md:pt-30 scroll-mt-[30px] md:scroll-mt-[0px]"
      >
          ...
          {[
            {
              ...
              back: (
                <>
                  ...
                  <img src={roadmapimg} alt="로드맵 미리보기" className="w-64 mx-auto rounded-lg" />
