...
function Report() {
  ...
  return (
    <div className="flex font-[pretendard] flex-col items-center justify-center px-4 py-10 text-center">
      ...
      <p className="text-lg font-semibold text-black">TakeIT과 함께한 학습 여정,<br />이제 더 나은 방향을 향해 나아갑니다.</p>
      ...
      <div className="flex justify-center space-x-4 mt-4 text-sm text-gray-600">
        <div className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-blue-500"></span> 2020</div>
        <div className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-pink-500"></span> 2021</div>
        <div className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-cyan-400"></span> 2022</div>
      </div>
